...
extension GetDailyGeofenceRecordCollection on Isar {
  IsarCollection<DailyGeofenceRecord> get dailyGeofenceRecords =>
      this.collection();
}

const DailyGeofenceRecordSchema = CollectionSchema(
  name: r'DailyGeofenceRecord',
  id: -9051227589135802072,
  properties: {
    r'dailyTimeSpentInSeconds': PropertySchema(
      id: 0,
      name: r'dailyTimeSpentInSeconds',
  ...
  estimateSize: _dailyGeofenceRecordEstimateSize,
  serialize: _dailyGeofenceRecordSerialize,
  deserialize: _dailyGeofenceRecordDeserialize,
  deserializeProp: _dailyGeofenceRecordDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _dailyGeofenceRecordGetId,
  getLinks: _dailyGeofenceRecordGetLinks,
  attach: _dailyGeofenceRecordAttach,
  version: '3.1.0+1',
);

int _dailyGeofenceRecordEstimateSize(
  DailyGeofenceRecord object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _dailyGeofenceRecordSerialize(
  DailyGeofenceRecord object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  writer.writeLong(offsets[0], object.dailyTimeSpentInSeconds);
  writer.writeDateTime(offsets[1], object.date);
  writer.writeLong(offsets[2], object.geofenceId);
}

DailyGeofenceRecord _dailyGeofenceRecordDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = DailyGeofenceRecord(
    dailyTimeSpentInSeconds: reader.readLong(offsets[0]),
    date: reader.readDateTimeOrNull(offsets[1]),
    geofenceId: reader.readLongOrNull(offsets[2]),
  );
  object.id = id;
  return object;
}

P _dailyGeofenceRecordDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _dailyGeofenceRecordGetId(DailyGeofenceRecord object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _dailyGeofenceRecordGetLinks(
    DailyGeofenceRecord object) {
  return [];
}

void _dailyGeofenceRecordAttach(
    IsarCollection<dynamic> col, Id id, DailyGeofenceRecord object) {
  object.id = id;
}

extension DailyGeofenceRecordQueryWhereSort
    on QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QWhere> {
  QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }
...
extension DailyGeofenceRecordQueryWhere
    on QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QWhereClause> {
  QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QAfterWhereClause>
      idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: id,
...
extension DailyGeofenceRecordQueryFilter on QueryBuilder<DailyGeofenceRecord,
    DailyGeofenceRecord, QFilterCondition> {
  QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QAfterFilterCondition>
      dailyTimeSpentInSecondsEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'dailyTimeSpentInSeconds',
...
extension DailyGeofenceRecordQueryObject on QueryBuilder<DailyGeofenceRecord,
    DailyGeofenceRecord, QFilterCondition> {}

extension DailyGeofenceRecordQueryLinks on QueryBuilder<DailyGeofenceRecord,
    DailyGeofenceRecord, QFilterCondition> {}

extension DailyGeofenceRecordQuerySortBy
    on QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QSortBy> {
  QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QAfterSortBy>
      sortByDailyTimeSpentInSeconds() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyTimeSpentInSeconds', Sort.asc);
    });
...
extension DailyGeofenceRecordQuerySortThenBy
    on QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QSortThenBy> {
  QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QAfterSortBy>
      thenByDailyTimeSpentInSeconds() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyTimeSpentInSeconds', Sort.asc);
...
extension DailyGeofenceRecordQueryWhereDistinct
    on QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QDistinct> {
  QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QDistinct>
      distinctByDailyTimeSpentInSeconds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dailyTimeSpentInSeconds');
    });
...
extension DailyGeofenceRecordQueryProperty
    on QueryBuilder<DailyGeofenceRecord, DailyGeofenceRecord, QQueryProperty> {
  QueryBuilder<DailyGeofenceRecord, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<DailyGeofenceRecord, int, QQueryOperations>
      dailyTimeSpentInSecondsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dailyTimeSpentInSeconds');
    });
  ...
  QueryBuilder<DailyGeofenceRecord, DateTime?, QQueryOperations>
      dateProperty() {
    return QueryBuilder.apply(this, (query) {
